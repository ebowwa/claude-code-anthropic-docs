...
Downloaded: 2026-08-11T20:43:49.267Z
-->
...
| `RemoteTrigger`        | Creates, updates, runs, and lists [Routines](/docs/en/routines) on claude.ai, and, on Claude Code v2.1.225 or later, attaches [GitHub triggers](/docs/en/routines#add-a-github-trigger) to them. On Claude Code v2.1.227 or later, also reads a routine's recent runs and their logs. Backs the `/schedule` command. Routines live on claude.ai and require a Pro, Max, Team, or Enterprise plan, so this tool is not accessible from Amazon Bedrock, Google Cloud's Agent Platform, or Microsoft Foundry. The tool is also absent when your organization's policy disables Claude Code on the web. On Claude Code v2.1.227 or later, it is also absent when your organization's policy disables [routines](/docs/en/routines#routines-are-disabled-by-your-organizations-policy)                                                                                                                                                                                                              | No                  |
